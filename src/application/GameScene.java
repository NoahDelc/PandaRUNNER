...
public class GameScene extends Scene {
	...
	//** CONSTRUCTEUR **//
		public GameScene(Parent parent, double width, double height, boolean depthBuffer) {
			...
			this.setGameOverPane(new staticThing(1000,600,"GameOver"));
			...
			this.textScore = new Text(10,10, "Score : " + Score);
			Font font = Font.loadFont("Font/Typographica-Blp5.ttf", 100);
	        textScore.setFont(font);
			textScore.setFill(Color.BLACK);
	        textScore.setTextAlignment(TextAlignment.CENTER);
	        
	        this.textPause = new Text(750,10, "");
	        textPause.setFont(font);
			textPause.setFill(Color.BLACK);
	        textPause.setTextAlignment(TextAlignment.CENTER);
	        
	       /* this.textStart = new Text(300,200, "Appuyez sur ENTER pour commencer");
	        textStart.setFont(font);
			textStart.setFill(Color.BLACK);
	        textStart.setTextAlignment(TextAlignment.CENTER);*/
